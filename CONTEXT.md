...
- There is no team **About Me Profile**. Engram's live store remains target-local,
  while project-scoped **Engram chunk sets** may circulate by **Grant** only
  after Engram attests their scope; personal observations and session summaries
  never cross a principal boundary (ADR 0022).
