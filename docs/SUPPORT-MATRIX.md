...
| chezmoi 2.70.4 safe subset | Isolation contract | Isolation contract | Isolation contract | Controller-isolated materialization for SSH targets; destination-observing features remain denied |
